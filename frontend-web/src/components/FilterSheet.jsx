      ...
      >
        ...
        <div className="mt-6 flex gap-3">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex-1 rounded-xl bg-gradient-to-r from-violet-500 to-pink-500 py-2.5 text-sm font-semibold text-ink-on-brand shadow-lg shadow-violet-500/25"
          >
            Appliquer
          </button>
        </div>
