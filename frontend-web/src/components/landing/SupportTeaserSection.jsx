  ...
  return (
    <section id="soutenir" className="mx-auto max-w-4xl scroll-mt-20 px-4 py-24 sm:px-10">
      ...
      >
        ...
        <h2 className="mt-5 font-display text-3xl font-bold text-[#261b28] sm:text-4xl">
          Construisons BomaVibes ensemble
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-[#635a65]">
        ...
        <Link
          to="/soutenir"
          className="mt-7 inline-block rounded-xl bg-pink-500 px-8 py-3.5 text-sm font-semibold text-[#261b28] shadow-lg transition hover:-translate-y-0.5 hover:bg-pink-400"
        >
          Soutenir BomaVibes
        </Link>
      </motion.div>
