...
function UpdateCardSkeleton() {
  return (
    <div className="animate-pulse rounded-3xl border border-violet-600/8 bg-white p-6">
      <div className="h-3 w-24 rounded bg-violet-600/10" />
      <div className="mt-3 h-4 w-3/4 rounded bg-violet-600/10" />
      <div className="mt-3 h-3 w-full rounded bg-violet-600/8" />
      <div className="mt-2 h-3 w-2/3 rounded bg-violet-600/8" />
    </div>
  )
}
              ...
              return (
                ...
                >
                  ...
                  {u.ctaLink && (
                    <a
                      href={u.ctaLink}
                      className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-violet-600 underline-offset-4 hover:underline"
                    >
