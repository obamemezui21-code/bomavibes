...
const ACTIONS = [
  ...
  { direction: 'superlike', icon: '★', label: 'Super like', className: 'h-11 w-11 text-lg text-gold-400' },
  { direction: 'like', icon: '♥', label: 'Aimer', className: 'h-14 w-14 text-2xl text-forest-500' },
]
...
function Discover() {
  ...
  return (
    <div className="relative flex min-h-svh flex-col items-center gap-6 overflow-hidden bg-ink p-6 md:min-h-full">
      <div className="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-forest-500/20 blur-[100px]" />
      <div className="pointer-events-none absolute -right-20 bottom-0 h-64 w-64 rounded-full bg-gold-500/10 blur-[100px]" />

      <div className="relative z-10 flex w-full max-w-sm items-center justify-between">
        <div>
          <h1 className="font-display text-2xl font-semibold text-cream-100">Découvrir</h1>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-base text-cream-200 transition hover:border-gold-400/50 hover:text-gold-400"
            aria-label="Filtres"
            title="Filtres"
          >
            ⚙
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-lg text-cream-200 transition hover:border-gold-400/50 hover:text-gold-400 disabled:cursor-not-allowed disabled:opacity-30"
        ...
        {visible.length === 0 ? (
          ...
          >
            ...
            <motion.button
              ...
              className="mt-2 rounded-xl bg-gradient-to-r from-gold-500 to-gold-400 px-5 py-2 text-sm font-semibold text-forest-950 shadow-lg shadow-gold-500/20"
            >
              Recharger la liste
            </motion.button>
          </motion.div>
      ...
      <AnimatePresence>
        {matchedProfile && (
          ...
          >
            ...
            >
              <div className="pointer-events-none absolute -left-10 -top-10 h-40 w-40 rounded-full bg-gold-500/30 blur-[60px]" />
              ...
              <motion.p
                ...
                className="relative font-display text-3xl font-bold text-gradient-gold"
              >
                C'est un match !
              </motion.p>
              <p className="relative mt-2 text-sm text-cream-300/80">
              ...
              <div className="relative mt-6 flex items-center justify-center">
                ...
                <motion.img
                  ...
                  animate={{ x: 14, rotate: 6, opacity: 1 }}
                  transition={{ delay: 0.2 }}
                  src="https://api.dicebear.com/9.x/adventurer/svg?seed=You&backgroundColor=c9962b"
                  alt="Toi"
                  className="h-24 w-24 rounded-full border-4 border-forest-950 object-cover shadow-xl"
                />
              </div>
              ...
              <div className="relative mt-8 flex flex-col gap-2">
                <motion.button
                  ...
                  className="rounded-xl bg-gradient-to-r from-gold-500 to-gold-400 py-2.5 text-sm font-semibold text-forest-950 shadow-lg shadow-gold-500/20"
                >
                  Envoyer un message
                </motion.button>
                <button
                  ...
                  className="rounded-xl border border-white/10 py-2.5 text-sm font-medium text-cream-200 transition hover:bg-white/5"
                >
